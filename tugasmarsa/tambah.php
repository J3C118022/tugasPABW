...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">Marsa Wafira</a>
    ...
    <div class="container" style="margin-top:20px">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (mysqli_num_rows($cek) == 0) {
                if (in_array($ekstensi, $ekstensi_diperbolehkan) == true) {
                    if ($ukuran < 90000000000) {
                        move_uploaded_file($file_tmp, 'foto/' . $foto_nama);
                        $sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(nim, nama, jenis_kelamin, agama, olahraga, nama_foto) VALUES('$nim', '$nama', '$jenis_kelamin', '$agama', '$olahraga', '$foto_nama')") or die(mysqli_error($koneksi));
        ...
        <form action="tambah.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="olahraga" value="Berenang">
                        <label class="form-check-label">
                            Berenang
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="olahraga" value="Tennis">
                        <label class="form-check-label">
                            Tennis
                        </label>
                    </div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="olahraga" value="Voli">
                        <label class="form-check-label">
                            Voli
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="olahraga" value="Pingpong">
                        <label class="form-check-label">
                            Pingpong
                        </label>
                    </div>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Upload Foto Profil</label>
                <div class="col-sm-10">
