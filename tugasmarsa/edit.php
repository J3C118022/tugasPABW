...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			<a class="navbar-brand" href="index.php">Ayu VP</a>
		...
		<form action="edit.php?id=<?php echo $id; ?>" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" name="olahraga" value="Tennis" <?php if ($data['olahraga'] == 'Tennis') {
																											echo 'checked';
																										} ?>>
						<label class="form-check-label">
							Tennis
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" name="olahraga" value="Voli" <?php if ($data['olahraga'] == 'Voli') {
																											echo 'checked';
																										} ?>>
						<label class="form-check-label">
							Voli
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" name="olahraga" value="Pingpong" <?php if ($data['olahraga'] == 'Pingpong') {
																											echo 'checked';
																										} ?>>
						<label class="form-check-label">
							Pingpong
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<img src="<?php echo "file/" . $data['nama_file']; ?>" width="100px" disabled>
					<label class="form-check-label" disabled>Mohon maaf tidak dapat update File Upload</label>
				</div>
			</div>
			<div class="form-group row">
